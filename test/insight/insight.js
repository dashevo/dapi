...
describe('Insight', () => {
    ...
    describe('#getAddressTotalReceived', () => {
        ...
        [testAddress.addrStr.substring(0, testAddress.addrStr.length - 1), testAddress.addrStr.substring(1, testAddress.addrStr.length), 123456789].forEach((ad) => {
    ...
    describe('#getAddressTotalSent', () => {
        ...
        [testAddress.addrStr.substring(0, testAddress.addrStr.length - 1), testAddress.addrStr.substring(1, testAddress.addrStr.length), 123456789].forEach((ad) => {
            it('Should return error if Invalid address: Checksum mismatch', () => expect(insight.getAddressTotalSent(ad)).to.be.rejectedWith('Invalid address: Checksum mismatch. Code:1'));
        });
    ...
    describe('#getAddressUnconfirmedBalance', () => {
        ...
        [testAddress.addrStr.substring(0, testAddress.addrStr.length - 1), testAddress.addrStr.substring(1, testAddress.addrStr.length), 123456789].forEach((ad) => {
            it('Should return error if Invalid address: Checksum mismatch', () => expect(insight.getAddressUnconfirmedBalance(ad)).to.be.rejectedWith('Invalid address: Checksum mismatch. Code:1'));
        });
    ...
    describe('#getAddressSummary', () => {
        ...
        [testAddress.addrStr.substring(0, testAddress.addrStr.length - 1), testAddress.addrStr.substring(1, testAddress.addrStr.length), 123456789].forEach((ad) => {
            it('Should return error if Invalid address: Checksum mismatch', () => expect(insight.getAddressSummary(ad)).to.be.rejectedWith('Invalid address: Checksum mismatch. Code:1'));
        });
    ...
    describe('#getTransactionsByAddress', () => {
        ...
        [testAddress.addrStr.substring(0, testAddress.addrStr.length - 1), testAddress.addrStr.substring(1, testAddress.addrStr.length), 123456789].forEach((ad) => {
            it('Should return error if Invalid address: Checksum mismatch', () => expect(insight.getTransactionsByAddress(ad)).to.be.rejectedWith('Invalid address: Checksum mismatch. Code:1'));
        });
    ...
    describe('#getBalance', () => {
        ...
        [testAddress.addrStr.substring(0, testAddress.addrStr.length - 1), testAddress.addrStr.substring(1, testAddress.addrStr.length), 123456789].forEach((ad) => {
            it('Should return error if Invalid address: Checksum mismatch', () => expect(insight.getBalance(ad)).to.be.rejectedWith('Invalid address: Checksum mismatch. Code:1'));
        });
    ...
    describe('#getUTXO', () => {
        ...
        [testAddress.addrStr.substring(0, testAddress.addrStr.length - 1), testAddress.addrStr.substring(1, testAddress.addrStr.length), 123456789].forEach((ad) => {
            it('Should return error if Invalid address: Checksum mismatch', () => expect(insight.getUTXO(ad)).to.be.rejectedWith('Invalid address: Checksum mismatch. Code:1'));
        });
    ...
    describe('#getHashFromHeight', () => {
        ...
        [testAddress.addrStr.substring(0, testAddress.addrStr.length - 1), testAddress.addrStr.substring(1, testAddress.addrStr.length), 123456789].forEach((ad) => {
            it('Should return error if Invalid address: Checksum mismatch', () => expect(insight.getHashFromHeight(ad)).to.be.rejectedWith('Invalid address: Checksum mismatch. Code:1'));
        });
    ...
    describe('#getStatus', () => {
        beforeEach(() => {
            ...
            requestStub
                .withArgs(`${URI}/status?q=getDifficulty`)
                .returns(new Promise(resolve => resolve({difficulty: testStatus.info.blocks.info.difficulty})));
            requestStub
                .withArgs(`${URI}/status?q=getBestBlockHash`)
                .returns(new Promise(resolve => resolve({bestblockhash: testHashFromHeight.blockHash.blockHash})));
    ...
    describe('#estimateFee', () => {
        ...
        [testAddress.addrStr.substring(0, testAddress.addrStr.length - 1), testAddress.addrStr.substring(1, testAddress.addrStr.length), 123456789].forEach((ad) => {
            it('Should return error if Invalid address: Checksum mismatch', () => expect(insight.estimateFee(ad)).to.be.rejectedWith('Expected type number, got null. Code:-3'));
        });
