...
describe('lib/rpcServer/index', () => {
    describe('#factory', () => {
        ...
        ['estimateFee', 'getAddressSummary', 'getAddressTotalReceived', 'getAddressTotalSent',
            ...
            'getDapContract', 'searchDapContracts', 'searchUsers', 'sendRawIxTransaction'].forEach(function (f) {
        ...
        ['estimateFee', 'getAddressSummary', 'getAddressTotalReceived', 'getAddressTotalSent',
            ...
            'getUserDapContext', 'getDapContract', 'searchDapContracts', 'searchUsers'].forEach(function (f) {
