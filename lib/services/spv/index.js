      ...
      message.inventory.forEach((m) => {
        ...
        switch (m.type) {
          case 1: // MSG_TX: if bloomfilter set this only happens on matched txs + false positives
            ...
            break;
          case 2:
            // MSG_BLOCK: not needed for SPV
            // TODO: requesting forFilteredBlock ALWAYS returns a merkleblock
            // regardless if it matches set bloomfilter
            this.peer.sendMessage(this.peer.messages.GetData.forFilteredBlock(cHash));
            break;
          case 3:
            // MSG_FILTERED_BLOCK:
            // TODO: This never happens regardless of bloomfilter set or not
            this.peer.sendMessage(this.peer.messages.GetData.forFilteredBlock(cHash));
            break;
          default:
        }
