...
const VersionMismatchGrpcError = require('@dashevo/grpc-common/lib/server/error/VersionMismatchGrpcError');
...
function createGrpcErrorFromDriveResponse(code, info) {
  ...
  switch (code) {
    ...
    case GrpcErrorCodes.VERSION_MISMATCH:
      return new VersionMismatchGrpcError(decodedInfo.metadata);
