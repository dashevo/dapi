 ...
 */
function platformHandlersFactory(rpcClient, driveAPI) {
  ...
  // getDocuments
  const getDocumentsHandler = getDocumentsHandlerFactory(driveAPI);
  ...
  // getDataContract
  const getDataContractHandler = getDataContractHandlerFactory(driveAPI);
