...
// Address indexing needs to be enabled (todo getting invalid address, perhaps this should be in SDK)
...
const getBlock = hash => new Promise((resolve, reject) => {
  client.getblock(hash, (err, r) => {
    if (err) {
      reject(err);
    }
    resolve(r.result);
