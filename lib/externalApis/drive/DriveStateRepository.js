...
class DriveStateRepository {
   ...
   * @return {Promise<Buffer>}
   */
  async fetchIdentityByPublicKeyHash(publicKeyHash) {
    return this.request(`/identities/by-public-key-hash/${publicKeyHash}`);
  }
   ...
   * @return {Promise<string>}
   */
  async fetchIdentityIdByPublicKeyHash(publicKeyHash) {
    return this.request(`/identities/by-public-key-hash/${publicKeyHash}/id`);
  }
}
