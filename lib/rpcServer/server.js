...
const createCommands = (
  ...
  getIdentity: getIdentityHandlerFactory(tendermintRpcClient, handleAbciResponse),
  applyStateTransition: applyStateTransitionHandlerFactory(tendermintRpcClient, handleAbciResponse),
  getDataContract: getDataContractHandlerFactory(driveAPI, dpp),
  getDocuments: getDocumentsHandlerFactory(driveAPI, dpp),
});
