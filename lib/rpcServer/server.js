...
const createCommands = (insightAPI, dashcoreAPI, driveAPI, tendermintRpcClient, dpp) => ({
...
const start = ({
  ...
  const commands = createCommands(insightAPI, dashcoreAPI, driveAPI, tendermintRpcClient, dpp);
