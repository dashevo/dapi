...
const commands = {
  ...
  sendRawTransition: sendRawTransition(insightAPI, dashDrive),
  getUserDapSpace: getUserDapSpace(dashDrive),
  getUserDapContext: getUserDapContext(dashDrive),
...
Object.keys(commands).forEach((commandName) => {
  commands[commandName] = errorDecorator(commands[commandName]);
});
