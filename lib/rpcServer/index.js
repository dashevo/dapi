...
const createCommands = (insightAPI, dashcoreAPI, dashDriveAPI, userIndex) => ({
  ...
  // Methods that are invoking DashDrive
  sendRawTransition: sendRawTransition(dashcoreAPI, dashDriveAPI),
  getUserDapSpace: getUserDapSpace(dashDriveAPI),
  getUserDapContext: getUserDapContext(dashDriveAPI, userIndex),
  getDapContract: getDapContract(dashDriveAPI),
