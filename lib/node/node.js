...
class Node {
    constructor(params) {
        ...
        this.nodeListHeartBeatInterval = 6000; // interval in milliseconds; 15 min. = 900000
        this.init();
...
// remove and add this node with new timestamp
// clean list by removing nodes that have timestamp > 30 min.
