const OPTIONS = {
  ...
  PLATFORM_GRPC_PORT: 'PLATFORM_GRPC_PORT',
...
DEFAULT_CONFIG[OPTIONS.CORE_GRPC_PORT] = 3005;
DEFAULT_CONFIG[OPTIONS.PLATFORM_GRPC_PORT] = 3006;
DEFAULT_CONFIG[OPTIONS.TX_FILTER_STREAM_GRPC_PORT] = 3010;
...
module.exports = {
  ...
  core: {
    grpcServer: {
      port: parseInt(config[OPTIONS.CORE_GRPC_PORT], 10),
    },
  },
  platform: {
    grpcServer: {
      port: parseInt(config[OPTIONS.PLATFORM_GRPC_PORT], 10),
    },
  },
  txFilterStream: {
    grpcServer: {
