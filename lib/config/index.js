const OPTIONS = {
  ...
  DASHDRIVE_IPFS_PORT: 'DASHDRIVE_IPFS_PORT',
};
...
module.exports = {
  ...
  dashdrive: {
    ipfs: {
      port: config[OPTIONS.DASHDRIVE_IPFS_PORT],
    },
  },
};
