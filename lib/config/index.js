...
DEFAULT_CONFIG[OPTIONS.P2P_HOST] = '127.0.0.1';
DEFAULT_CONFIG[OPTIONS.P2P_PORT] = 19999;
DEFAULT_CONFIG[OPTIONS.P2P_NETWORK] = 'testnet';
...
module.exports = {
  ...
  dashcore: {
    ...
    p2p: {
      host: config[OPTIONS.P2P_HOST],
      port: config[OPTIONS.P2P_PORT],
      network: config[OPTIONS.P2P_NETWORK],
    },
  },
};
